...
local READABLE_SELECTING_HAND =
  ...
  .. "Playing a hand spends nothing until the commit goes through: the play_hand action description states whether play_hand itself commits, or whether it returns a confirmation that confirm_play must answer. "
...
local READABLE_COMMON =
  "How to decide: read the situation and your available actions, drop any blocked by money, slots, hands, discards, or targets, then call exactly ONE action type. Confirming a sell means sending that same action again with identical arguments -- that is the commit, not a second move. "
