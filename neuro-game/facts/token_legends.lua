...
local READABLE_COMMON =
  "How to decide: read the situation and your available actions, drop any blocked by money, slots, hands, discards, or targets, then call exactly ONE action type. Confirming a sell means sending that same action again with identical arguments; confirming a play means answering confirm_play -- that is the commit, not a second move. "
