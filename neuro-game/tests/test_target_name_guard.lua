...
check("a listing-truncated prefix is rejected", guard("Jolly Joker", "Jolly Jok") ~= nil)
...
check("dropping a leading 'The' is rejected",
  guard("The Hierophant", "Hierophant") ~= nil, tostring(guard("The Hierophant", "Hierophant")))
check("adding a leading 'The' is rejected",
